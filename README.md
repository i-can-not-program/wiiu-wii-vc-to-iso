...
1. Once it has finished run OTP2SD and SEEPROM2SD. (you may need to run [Mocha CFW](https://github.com/dimok789/mocha/releases/download/v0.2/mocha.v0.2.zip) before OTP2SD etc.)
